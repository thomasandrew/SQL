...
---EX16
/* SELECT DISTINCT idcliente, EXTRACT (YEAR FROM dtcompra) AS com
  FROM compras
...
SELECT nomecliente, estadocivil, estado
  FROM cliente
 WHERE estado IN ('Rio de Janeiro', 'São Paulo', 'Minas Gerais'); 
 
SELECT nomecliente, estadocivil, estado
  FROM cliente
 WHERE estado NOT IN ('Rio de Janeiro', 'São Paulo', 'Minas Gerais');  
